...
def display_can_cost(selected_can):#added .name to selected_can istead of .price
...
def coin_selection(): #changed enter prompts to numbers to match dict
...
def end_message(selected_soda, change_amount):
    ...
    print(f'Enjoy your {selected_soda.name}') # changed soda to soda_name
    if change_amount >= 0:
